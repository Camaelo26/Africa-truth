...
main_settings:{
        ...
        div: 'map',
        auto_load: 'yes',
        url_new_tab: 'no', // Open in the same tab
...
state_specific:{ 
	...
	CF: { 
		...
		color: 'default',
		hover_color: 'default',
		url: 'centralafricanrepublic.html',
		hide: 'no',
		inactive: 'no'
	},
